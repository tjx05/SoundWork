...
INTENSITY_DICT = {0: "LO", 1: "MD", 2: "HI", -1: "XX"}
...
class Wav2vec2Recognizer:
    ...
    """
    # 默认加载四核权重
    def __init__(self, model_path="./emotion_checkpoints/best_wav2vec2_model1.pth", device=None):
        if device is None:
